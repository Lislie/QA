  ...
  .content {
    ...
    .cg {
      ...
      .cg2 {
        ...
        width: 25px;
        height: 19px;
        background: url('./tjhdcg.png') no-repeat;
        background-size: 100%;
      }
  ...
  <div class="myQ">
    ...
    <div class="content" style="margin: 0">
      ...
      <div class="ck">
        ...
        <div :class="isTogel2 ? 'a_content' : 'a_content hideSome' "  @copy="false" v-html="reference" ref="can">
        </div>
        <el-button type="text" @click='detailTogel2' class="btn3" v-show="btn2">{{buttonText2}}</el-button>
      </div>
      <div class="bad" v-show="errorList" v-for="(item,inedex) in errorList">
        <div class="bad_t">
          <span></span>
          <h2>错误回答</h2>
        </div>
...
export default {
  ...
  methods: {
    ...
    //     var xx = this.$ref.xx.offsetHeight;
    //     if (xx > 150) {
    //       _this.isTogel = false
    //       _this.err = true
    //     }
