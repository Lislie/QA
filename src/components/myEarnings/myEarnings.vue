                ...
                <div class="search">
                    <div class="search_top">
                        ...
                        <div class="type">
                            ...
                            <template>
                                <el-select v-model="inquireParam.transactionType" clearable placeholder="请选择">
                                    <el-option
                        ...
                        <div class="state">
                            ...
                            <template>
                                <el-select v-model="inquireParam.transactionState" clearable placeholder="请选择">
                                    <el-option
                ...
                <div class="list">
                    <table width="100%" class="table">
                        ...
                        <tr style="height:69px" v-for="(item,index) in listData">
                            ...
                            <td v-if="item.type == 0" style="text-align:left;line-height:18px">{{item.content}}</td>
...
export default {
    ...
    watch:{
        changeDate(curVal,oldVal){
            ...
            // console.log(curVal+'=='+this.inquireParam.startDate+'=='+this.inquireParam.endDate)
        }
    },
    methods: {
        // 获取用户信息
